...
pub struct UnixDatagram {
    io: PollEvented<sys::net::UnixDatagram>,
}
...
impl UnixDatagram {
    ...
    pub fn bind(path: impl AsRef<Path>) -> io::Result<UnixDatagram> {
        let socket = sys::net::UnixDatagram::bind(path)?;
    ...
    pub fn pair() -> io::Result<(UnixDatagram, UnixDatagram)> {
        let (a, b) = sys::net::UnixDatagram::pair()?;
    ...
    fn new(socket: sys::net::UnixDatagram) -> UnixDatagram {
    ...
    pub fn unbound() -> io::Result<UnixDatagram> {
        let socket = sys::net::UnixDatagram::unbound()?;
        Ok(UnixDatagram::new(socket))
    }
